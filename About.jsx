...
export default function About() {
  return (
    <section id="about" className="border-t border-white/10 bg-[#0A0A0C]">
      <div className="max-w-5xl mx-auto px-6 py-24 md:py-32">
        <p className="font-mono text-[12px] tracking-[0.3em] uppercase text-[#D2FF00]">About</p>
...
"
        ...
        <div className="mt-10 flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-10 font-mono text-[11px] tracking-[0.2em] uppercase text-[#8E8E93]">
          <div className="flex items-center gap-3">
            <span className="w-8 h-8 rounded-full bg-[#1A1A1E] border border-white/15 flex items-center justify-center text-[#D2FF00] text-[12px]">SW</span>
            <span>Samuel Williams — Lead Developer</span>
          </div>
          <div className="flex items-center gap-3">
            <span className="w-8 h-8 rounded-full bg-[#1A1A1E] border border-white/15 flex items-center justify-center text-[#D2FF00] text-[12px]">HB</span>
